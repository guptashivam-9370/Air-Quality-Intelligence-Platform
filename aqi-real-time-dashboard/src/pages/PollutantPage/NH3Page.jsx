...
import Dialer from '../../components/real-time-pollutant-page/nh3/Dialer';
import Component1 from '../../components/real-time-pollutant-page/nh3/component1';
import Component3 from '../../components/real-time-pollutant-page/nh3/component3';
import Component4 from '../../components/real-time-pollutant-page/nh3/component4';
import Component5 from '../../components/real-time-pollutant-page/nh3/component5';
import HistoricalChart from '../../components/real-time-pollutant-page/nh3/HistoricalChart';
import HistoricalHistogram from '../../components/real-time-pollutant-page/nh3/HistoricalHistogram';
...
function NH3Page() {
  ...
  const initialPM10Value =
    location.state?.pollutantValue || location.state?.pollutantData?.nh3 || null;
  const initialPollutantData = location.state?.pollutantData || {};
  const initalselectedStation = location.state?.selectedStation || null;
  const initialhistoricalData = location.state?.historicalData || null;
  // Removed initialPM25Value from location state and set PM2.5 initial value to null
  const [stations, setStations] = useState([]);
  const [selectedStation, setSelectedStation] = useState(initalselectedStation);
  const [searchTerm, setSearchTerm] = useState('');
  const [filteredStations, setFilteredStations] = useState([]);
  const [pm25Value, setPM25Value] = useState(initialPM10Value);
  ...
  const [selectedPollutant, setSelectedPollutant] = useState('nh3');
