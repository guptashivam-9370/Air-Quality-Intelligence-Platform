...
import Dialer from '../../components/real-time-pollutant-page/co/Dialer';
import Component1 from '../../components/real-time-pollutant-page/co/component1';
import Component3 from '../../components/real-time-pollutant-page/co/component3';
import Component4 from '../../components/real-time-pollutant-page/co/component4';
import Component5 from '../../components/real-time-pollutant-page/co/component5';
import HistoricalChart from '../../components/real-time-pollutant-page/co/HistoricalChart';
import HistoricalHistogram from '../../components/real-time-pollutant-page/co/HistoricalHistogram';
...
function COPage() {
  ...
  const initialPM10Value =
    location.state?.pollutantValue || location.state?.pollutantData?.co || null;
