...
import Dialer from '../../components/real-time-pollutant-page/o3/Dialer';
import Component1 from '../../components/real-time-pollutant-page/o3/component1';
import Component3 from '../../components/real-time-pollutant-page/o3/component3';
import Component4 from '../../components/real-time-pollutant-page/o3/component4';
import Component5 from '../../components/real-time-pollutant-page/o3/component5';
import HistoricalChart from '../../components/real-time-pollutant-page/o3/HistoricalChart';
import HistoricalHistogram from '../../components/real-time-pollutant-page/o3/HistoricalHistogram';
...
function O3Page() {
  ...
  const initialPM10Value =
    location.state?.pollutantValue || location.state?.pollutantData?.o3 || null;
