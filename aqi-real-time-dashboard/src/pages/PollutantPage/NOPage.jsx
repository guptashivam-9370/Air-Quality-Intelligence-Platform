...
import Dialer from '../../components/real-time-pollutant-page/no/Dialer';
import Component1 from '../../components/real-time-pollutant-page/no/component1';
import Component3 from '../../components/real-time-pollutant-page/no/component3';
import Component4 from '../../components/real-time-pollutant-page/no/component4';
import Component5 from '../../components/real-time-pollutant-page/no/component5';
import HistoricalChart from '../../components/real-time-pollutant-page/no/HistoricalChart';
import HistoricalHistogram from '../../components/real-time-pollutant-page/no/HistoricalHistogram';
...
function NOPage() {
  ...
  const initialPM10Value =
    location.state?.pollutantValue || location.state?.pollutantData?.no || 0;
  ...
  const [selectedPollutant, setSelectedPollutant] = useState('no');
