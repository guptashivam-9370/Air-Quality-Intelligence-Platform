...
import Dialer from '../../components/real-time-pollutant-page/no2/Dialer';
import Component1 from '../../components/real-time-pollutant-page/no2/component1';
import Component3 from '../../components/real-time-pollutant-page/no2/component3';
import Component4 from '../../components/real-time-pollutant-page/no2/component4';
import Component5 from '../../components/real-time-pollutant-page/no2/component5';
import HistoricalChart from '../../components/real-time-pollutant-page/no2/HistoricalChart';
import HistoricalHistogram from '../../components/real-time-pollutant-page/no2/HistoricalHistogram';
...
function NO2Page() {
  ...
  const initialPM10Value =
    location.state?.pollutantValue || location.state?.pollutantData?.no2 || null;
